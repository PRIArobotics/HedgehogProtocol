...
from .grammar.HedgehogProtocolVisitor import Field, Oneof, PythonSpec, MandatoryParam, RepeatedParam, OptionalParam
from . import unique
        ...
        def message_class_code(messageClass):
            ...
            def message_init_code():
                def init_param_strs():
                    ...
                    def mandatory(param):
                        python = param.field.languageFieldSpecs[PythonSpec]
                    ...
                    def optional(param, i):
                        python = param.fields[i].languageFieldSpecs[PythonSpec]
